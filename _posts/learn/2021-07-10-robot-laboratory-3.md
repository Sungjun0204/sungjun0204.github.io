...
위 이미지는 각 사각파, 삼각파를 삼각함수의 급수로 표현한 것이다. 이런 식으로 많은 함수를 삼각함수의 급수로 표현할 수 있다.
...
샘플링 주파수는 1000Hz, 샘플링 주기는 0.001s로 설정하였다. 그리고 FFT를 하기 위한 신호 범위를 0~5000까지로 설정하기 위해 5001로 썼으며, 시간 범위는 0~5초까지로 설정하였다. 주파수 범위는 0~500Hz까지이며, 분해능은 0.2Hz로 설정했다.  
9번째 줄부터 보게 되면 허수부를 제거하는 식으로, 우리는 FFT의 값에 절대값을 씌워 크기만 도출할 것이다. 그리고 250Hz를 기준으로 켤례복소수가 발생하는데, 우리는 양수 부분만 볼 것이므로 하나로 처리하였다.  
...
| 코드라인 | 파형 | 설명 |
| :------ | :------: | :------ |
| 11번 | <img src="\assets\images\2021-07-10-robot-laboratory-3\img3.png" width="50%" height="50%"> | 크기: 2<br/>진동수: 1 | 
| 11+12번 | <img src="\assets\images\2021-07-10-robot-laboratory-3\img4.png" width="50%" height="50%"> | 크기: 0.5<br/>진동수: 10 |
| 11+12+13번 | <img src="\assets\images\2021-07-10-robot-laboratory-3\img5.png" width="50%" height="50%"> | 평균: 0<br/>표준편차: 0.8 |
